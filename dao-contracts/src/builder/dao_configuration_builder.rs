    ...
    pub fn defaults(
        ...
        DaoConfigurationBuilder {
            configuration: DaoConfiguration {
                ...
                reputation_conversion_rate: Self::get_variable(REPUTATION_CONVERSION_RATE, &variables),
                fiat_conversion_rate_address: Self::get_variable(FIAT_CONVERSION_RATE_ADDRESS, &variables),
                forum_kyc_required: Self::get_variable(FORUM_KYC_REQUIRED, &variables),
                governance_informal_quorum_ratio: Self::get_variable(GOVERNANCE_INFORMAL_QUORUM_RATIO, &variables),
                governance_formal_quorum_ratio: Self::get_variable(GOVERNANCE_FORMAL_QUORUM_RATIO, &variables),
                governance_informal_voting_time: Self::get_variable(GOVERNANCE_INFORMAL_VOTING_TIME, &variables),
                governance_formal_voting_time: Self::get_variable(GOVERNANCE_FORMAL_VOTING_TIME, &variables),
                ...
                informal_stake_reputation: Self::get_variable(INFORMAL_STAKE_REPUTATION, &variables),
                time_between_informal_and_formal_voting: Self::get_variable(TIME_BETWEEN_INFORMAL_AND_FORMAL_VOTING, &variables),
                va_bid_acceptance_timeout: Self::get_variable(VA_BID_ACCEPTANCE_TIMEOUT, &variables),
                va_can_bid_on_public_auction: Self::get_variable(VA_CAN_BID_ON_PUBLIC_AUCTION, &variables),
                distribute_payment_to_non_voters: Self::get_variable(DISTRIBUTE_PAYMENT_TO_NON_VOTERS, &variables),
                governance_wallet_address: Self::get_variable(GOVERNANCE_WALLET_ADDRESS, &variables),
                ...
                voting_start_after_job_worker_submission: Self::get_variable(VOTING_START_AFTER_JOB_WORKER_SUBMISSION, &variables),
