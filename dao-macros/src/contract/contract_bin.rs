        ...
        if has_return {
            quote! {
                ...
                fn #ident() {
                    ...
                    #casper_args
                    let contract: #contract_ident = casper_dao_utils::instance::Instanced::instance("instance");
            ...
            quote! {
                ...
                fn #ident() {
                    #casper_args
                    let mut contract: #contract_ident = casper_dao_utils::instance::Instanced::instance("instance");
        ...
        let expected = quote! {
            ...
            macro_rules! contract {
                () => {
                    ...
                    #[no_mangle]
                    fn init() {
                        let mut contract: Contract = casper_dao_utils::instance::Instanced::instance("instance");
