    ...
    context "governance voting" {
        ...
        describe "voting contact" {
            before {
                ...
                let (mut mock_voter_contract, variable_repo_contract, reputation_token_contract, va_token_contract)
                    = governance_voting_common::setup_voting_contract(informal_quorum, formal_quorum, total_onboarded);
            }
            ...
            it "emits event with correct values" {
                ...
                assert_eq!(mock_voter_contract.get_va_token_address(), va_token_contract.address());
                ...
                mock_voter_contract.assert_last_event(
                    VotingContractCreated {
                        ...
                        va_token: va_token_contract.address(),
