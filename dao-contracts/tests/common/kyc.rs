...
use super::{DaoWorld, params::{nft::Account, common::U256}};

impl DaoWorld {
    pub fn mint_kyc_token(&mut self, minter: &Account, recipient: &Account) -> Result<(), casper_dao_utils::Error> {
    ...
    pub fn checked_mint_kyc_token(&mut self, minter: &Account, recipient: &Account) {
        self.mint_kyc_token(minter, recipient).expect("A token should be minted");
    }

    pub fn burn_kyc_token(&mut self, burner: &Account, holder: &Account) -> Result<(), casper_dao_utils::Error> {
    ...
    pub fn checked_burn_kyc_token(&mut self, minter: &Account, recipient: &Account) {
        self.burn_kyc_token(minter, recipient).expect("A token should be burned");
    }
