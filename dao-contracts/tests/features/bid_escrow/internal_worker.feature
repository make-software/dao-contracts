Feature: Internal Flow
  ...
  Background:
    Given following balances
      ...
      | VA1              | 0            | 1000         | 0          |
      | VA2              | 0            | 1000         | 0          |
    And JobPoster posted a JobOffer with expected timeframe of 14 days and maximum budget of 1000 CSPR
    And InternalWorker posted the Bid with proposed timeframe of 7 days and 500 CSPR price and 100 Reputation stake
