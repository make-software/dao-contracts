...
use casper_dao_contracts::{reputation_voter::ReputationVotingCreated, simple_voter::SimpleVotingCreated};
use casper_types::bytesrepr::{FromBytes, Bytes, ToBytes};
use blake2::{VarBlake2b, Digest};
