...
fn call() {
    let schemas = vec![
        odra::casper::utils::build_event(
            String::from("SlashingVotingCreated"),
            vec![
                ("address_to_slash", odra::casper::casper_types::CLType::Key),
                ("slash_ratio", odra::casper::casper_types::CLType::U32),
    ...
    match constructor_name.as_str() {
        "init" => {
            ...
            let mut contract_ref =
                dao::voting_contracts::SlashingVoterContractRef::at(&odra_address);
...
fn init() {
    ...
    let (mut _contract, _): (dao::voting_contracts::SlashingVoterContract, _) =
...
fn update_slashable_contracts() {
    ...
    let slashable_contracts =
        odra::casper::casper_contract::contract_api::runtime::get_named_arg("slashable_contracts");
    _contract.update_slashable_contracts(slashable_contracts);
}
#[no_mangle]
fn create_voting() {
    odra::casper::utils::assert_no_attached_value();
    ...
    let address_to_slash =
        odra::casper::casper_contract::contract_api::runtime::get_named_arg("address_to_slash");
    let slash_ratio =
        odra::casper::casper_contract::contract_api::runtime::get_named_arg("slash_ratio");
    let stake = odra::casper::casper_contract::contract_api::runtime::get_named_arg("stake");
    _contract.create_voting(address_to_slash, slash_ratio, stake);
}
#[no_mangle]
fn vote() {
    odra::casper::utils::assert_no_attached_value();
...
fn voting_exists() {
    odra::casper::utils::assert_no_attached_value();
    let (_contract, _): (dao::voting_contracts::SlashingVoterContract, _) =
        odra::StaticInstance::instance(&[
            "",
            "",
            "",
...
fn get_ballot() {
    ...
    let voting_type =
        odra::casper::casper_contract::contract_api::runtime::get_named_arg("voting_type");
    let voter = odra::casper::casper_contract::contract_api::runtime::get_named_arg("voter");
    let result = _contract.get_ballot(voting_id, voting_type, voter);
    let result = odra::casper::casper_types::CLValue::from_t(result).unwrap_or_revert();
    odra::casper::casper_contract::contract_api::runtime::ret(result);
}
#[no_mangle]
