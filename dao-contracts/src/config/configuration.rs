...
impl Configuration {
    ...
    delegate! {
        to self.voting_configuration {
            ...
            pub (super) fn set_unbound_ballot_address(&mut self, unbound_ballot_address: Option<Address>);
            pub (super) fn set_is_bid_escrow(&mut self, is_bid_escrow: bool);
            pub (super) fn set_only_va_can_create(&mut self, only_va_can_create: bool);
            pub (super) fn set_contract_calls(&mut self, contract_calls: Vec<ContractCall>);
