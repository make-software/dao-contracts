use casper_dao_contracts::{OnboardingContractCaller, OnboardingContractInterface};
...
fn call() {
    ...
    OnboardingContractCaller::at(onboarding_address).submit_onboarding_request(reason, cargo_purse);
}
